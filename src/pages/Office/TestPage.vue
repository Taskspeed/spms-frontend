      ...
      <div class="preview-container" id="opcr-preview">
        ...
        <div class="header">
          ...
          <div class="center-text">
            <div class="text-body2">Republic of the Philippines</div>

            <div class="text-body2">Province of Davao del Norte</div>
            <div class="text-body2">CITY OF TAGUM</div>
          </div>
          <img src="/rotp.png" alt="Republic of the Philippines Logo" class="logo" />
        </div>

        <div class="text-body1 text-weight-bold center-text">
            ...
            <tbody>
              ...
              <tr>
                <td style="width: 100%; padding: 8px; border: 1px solid #000; vertical-align: top">
                  ...
                  the following targets in accordance with the indicated measures for the period of
                  <b>JANUARY–JUNE, 2024</b>.
        ...
        >
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                7,474 Recruitment, Selection and Placement related documents/activities approved and
                signed without lapses before the schedule
              </td>
              <td style="text-align: center">P 19,101,441.00 (Personal Services)</td>
              <td style="text-align: center">ARPMID</td>
              <td>
                9,712 Recruitment, Selection and Selection related documents/activities approved and
                signed with lapses within the schedule
              </td>
            ...
            <tr>
              ...
              <td>
                1,194 employees Compensation and Benefits related documents/activities approved and
                signed without lapses before the schedule
              </td>
              <td style="text-align: center">P 19,101,441.00 (Personal Services)</td>
            ...
            <tr>
              ...
              <td style="text-align: center">ASD, ARPMID, BHRDD</td>
              <td>
                240 DTRs reviewed without lapses within the 2nd working day of the succeeding month
              </td>
              <td style="text-align: center">5</td>
              <td style="text-align: center">5</td>
              <td style="text-align: center">3</td>
            ...
            <tr>
              ...
              <td>Not Applicable</td>
              <td>
                1 OPCR Accomplishment and 1 OPCR Target reviewed and submitted without lapses within
                deadline
              </td>
              <td style="text-align: center">P 19,750,511.00 (Personal Services)</td>
              <td style="text-align: center">ASD,ARPMID,BHRDD</td>
...
<script>
import { ref } from 'vue'
import InputPage from 'src/components/OPCRInput.vue'
